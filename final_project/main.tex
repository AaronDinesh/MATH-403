...
\newcommand{\thesistitle}{Randomized Nyström Preconditioning with RPChloesky} % Your thesis title, this is used in the title and abstract
...
\newcommand{\typeofthesis}{MATH-403 Final Project} % dissertation, Final Year Project, report, etc.
